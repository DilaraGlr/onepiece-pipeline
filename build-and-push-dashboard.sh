...
# Script pour construire et pusher l'image Docker du dashboard vers Artifact Registry
...
echo "=================================================="
echo "Build et push de l'image dashboard One Piece"
echo "=================================================="
...
echo ""
echo "✅ Image dashboard pushée avec succès!"
echo "   ${IMAGE_URL}"
echo ""
